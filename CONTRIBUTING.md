Note: This is the same contributing guidelines as that found in the [main AllenNLP repository](https://github.com/gabeorlanski/allennlp/blob/main/CONTRIBUTING.md).
